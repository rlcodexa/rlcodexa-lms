export const APTITUDE_MODULES = [
  ...
  },
  {
    ...
    icon: '📐',
    subModules: [
      { id: 'lcm-basics', title: 'LCM Basics', questions: [
      ...
      { id: 'hcf-applications', title: 'HCF Applications', questions: [
  ...
  },
  {
    ...
    subModules: [
      { id: 'pct-basics', title: 'Basic Percentage', questions: [
      ...
      { id: 'pct-profit-loss', title: 'Profit, Loss & Discount', questions: [
  ...
  },
  {
    ...
    subModules: [
      { id: 'pl-basics', title: 'Basic P&L', questions: [
      ...
      { id: 'pl-advanced', title: 'Advanced P&L', questions: [
  ...
  {
    id: 'interest', title: 'Simple & Compound Interest', icon: '📊',
    subModules: [
      { id: 'si-basics', title: 'Simple Interest', questions: [
      ...
      { id: 'ci-basics', title: 'Compound Interest', questions: [
  ...
  },
  {
    ...
    subModules: [
      { id: 'tsd-basics', title: 'Basic TSD', questions: [
      ...
      { id: 'tsd-trains', title: 'Trains & Platforms', questions: [
      ...
      { id: 'tsd-boats', title: 'Boats & Streams', questions: [
  ...
  },
  {
    ...
    subModules: [
      { id: 'tw-basics', title: 'Basic Time & Work', questions: [
      ...
      { id: 'tw-wages', title: 'Work & Wages', questions: [
  ...
  },
  {
    ...
    subModules: [
      { id: 'rp-basics', title: 'Basic Ratio', questions: [
      ...
      { id: 'rp-mixtures', title: 'Mixtures & Alligations', questions: [
  ...
  {
    id: 'average', title: 'Average', icon: '📈',
    subModules: [
      { id: 'avg-basics', title: 'Basic Averages', questions: [
      ...
      { id: 'avg-advanced', title: 'Advanced Averages', questions: [
        { q: 'Average of 20 numbers is 0. How many numbers can be > 0 at most?', options: ['19', '18', '20', '10'], answer: 0 },
        { q: 'Average weight of 6 men increases by 2 kg when one (80kg) leaves. New man weight:', options: ['92 kg', '84 kg', '88 kg', '90 kg'], answer: 0 },
  ...
  },
  {
    ...
    subModules: [
      { id: 'di-tables', title: 'Tables & Charts', questions: [
      ...
      { id: 'di-graphs', title: 'Graph Analysis', questions: [
  ...
  },
  {
    ...
    subModules: [
      { id: 'pc-permutations', title: 'Permutations', questions: [
      ...
      { id: 'pc-combinations', title: 'Combinations', questions: [
